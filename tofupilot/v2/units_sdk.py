...
class UnitsSDK(BaseSDK):
    ...
    def create_attachment(
        ...
        *,
        ...
        request = models.UnitCreateAttachmentRequest(
            serial_number=serial_number,
            request_body=models.UnitCreateAttachmentRequestBody(
                name=name,
            ),
        )
        ...
        req = self._build_request(
            method="POST",
            path="/v2/units/{serial_number}/attachments",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.UnitCreateAttachmentRequestBody,
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="unit-createAttachment",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.UnitCreateAttachmentResponse, http_res
            )
        if utils.match_response(http_res, "401", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorUNAUTHORIZEDData, http_res
    ...
    def delete_attachment(
        ...
        *,
        ...
        request = models.UnitDeleteAttachmentRequest(
            serial_number=serial_number,
            ids=ids,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="unit-deleteAttachment",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.UnitDeleteAttachmentResponse, http_res
            )
        if utils.match_response(http_res, "401", "application/json"):
            response_data = unmarshal_json_response(
                errors.ErrorUNAUTHORIZEDData, http_res
